...
class Application(Frame):
    ...
    def bind_buttons(self, master):
        ...
        master.bind("1", lambda event, char="Logan", btn=self.one_bttn: self.add_chr(char, btn))
    ...
    def create_widgets(self):
        ...
        self.one_bttn = Button(self, text="Logan", width=9, height=3, command=lambda: self.add_chr("Gunnin"))
